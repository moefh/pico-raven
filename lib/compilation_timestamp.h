...
static inline uint32_t get_compilation_year(void)
{
...
static inline uint32_t get_compilation_month(void)
{
...
static inline uint32_t get_compilation_day(void)
{
  if (__DATE__[4] == ' ') return __DATE__[5] - '0';
  return ((__DATE__[4] - '0') << 4) | (__DATE__[5] - '0');
}

static inline uint32_t get_compilation_time(void)
{
...
static inline uint32_t get_compilation_date(void)
{
...
static inline uint64_t get_compilation_timestamp(void)
{
    return (((uint64_t) get_compilation_date() << 32) |
            ((uint64_t) get_compilation_time()));
}
